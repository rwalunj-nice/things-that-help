...
- summary — 2-4 sentence plain text summary of the day's key signals. Do NOT wrap in any XML or HTML tags such as <run-summary>. Output the summary text and nothing else.
